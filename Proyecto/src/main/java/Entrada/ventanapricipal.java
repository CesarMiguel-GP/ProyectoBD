...
public class ventanapricipal extends javax.swing.JFrame {
    ...
    private void lblAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lblAbrirActionPerformed
        String usuariosInfo = Validador.obtenerUsuariosRegistrados();
        JOptionPane.showMessageDialog(this, usuariosInfo, "Usuarios Registrados", JOptionPane.INFORMATION_MESSAGE);
